                    ...
                    <Row>
                        ...
                        <Col xl={7} xs={12} className={'align-self-center'}>
                            <div className={styles.textbox}>
                                ...
                                <p>
                                    더욱이 품질 시스템의 정착을 위하여 2000년 ISO9001(영국EQA)를 획득과 ISO 14001,18001,<br/>
                                    45001, TS 29001, GOST-R인증에 이어 원자력 품질시스템(KEPIC-MN)의 인증과 고리원전품질<br/>
                                    등급 적격업체로 인정을 받아 발전사업부문의 영역을 개척하였습니다.
                                </p>
                            </div>
                        </Col>
                    </Row>
