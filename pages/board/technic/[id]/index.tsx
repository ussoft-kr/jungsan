...
const NoticeDetailPage = () => {
    ...
    const [notice, setNotice] = useState<TechnicTypes | null>(null); // 상태 변수로 공지사항 상세 정보 저장
    const [prevNotice, setPrevNotice] = useState<TechnicTypes | null>(null);
    const [nextNotice, setNextNotice] = useState<TechnicTypes | null>(null);
    const [file, setFile] = useState<TechnicTypes | null>(null);
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            await axios.delete(`/api/technic/delete`, {
                data: {ids: [Number(id)]},
            });
