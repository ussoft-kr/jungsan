...
import Layout from "component/en/common/Layout";

const enIndex:NextPage = () => {
                    ...
                    <Slider {...settings}>
                        <div className={styles.slideitem}>
                            <div className={styles.imgbox}>
                                ...
                                <Image src={'/mo/main/mo_main_img1.jpg'} alt={'main-img'}
                        ...
                        <div className={styles.slideitem}>
                            <div className={styles.imgbox}>
                                ...
                                <Image src={'/mo/main/mo_main_img2.jpg'} alt={'main-img'}
                                       className={'d-block d-xl-none'}/>
                            </div>
                            <div className={styles.textbox}>
                                <h3>JUNGSAN</h3>
                        ...
                        <div className={styles.slideitem}>
                            <div className={styles.imgbox}>
                                ...
                                <Image src={'/mo/main/mo_main_img3.jpg'} alt={'main-img'}
                                       className={'d-block d-xl-none'}/>
                            </div>
                            <div className={styles.textbox}>
                                <h3>JUNGSAN</h3>
                                        ...
                                        <Col>
                                            <div className={styles.downloadbox}>
                                                <div className={styles.imgbox}>
                                                    ...
                                                    <div className={styles.absolutebox}>
                                                        <Link href={'/data/download/jungsan ca_kr web out.pdf'}
                                                              target="_blank"
